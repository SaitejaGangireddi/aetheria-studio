  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-purple-500 selection:text-white relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute -top-[20%] -left-[10%] w-[600px] h-[600px] rounded-full bg-purple-900/20 blur-[140px] animate-pulse" />
        <div className="absolute top-[40%] -right-[10%] w-[700px] h-[700px] rounded-full bg-indigo-900/20 blur-[160px] animate-pulse [animation-delay:2s]" />
      </div>

      <Navbar onOpenModal={() => setIsModalOpen(true)} />

      <main className="relative z-10 pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto space-y-24">
        
        {/* Hero Header Section */}
        <section className="text-center max-w-4xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-950/90 border border-purple-800/80 text-purple-300 text-xs font-bold uppercase tracking-widest shadow-[0_0_20px_rgba(168,85,247,0.2)]">
          ...
          <p className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
            Bridging complex enterprise software architecture with high-converting, sub-second edge experiences designed for global scale.
          </p>
        </section>

        {/* Founder Card */}
        <section className="relative max-w-5xl mx-auto">
          <div className="group relative bg-slate-900/70 border border-slate-800/90 rounded-3xl p-8 md:p-12 backdrop-blur-2xl transition-all duration-500 hover:border-purple-500/60 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
            ...
            <div className="grid lg:grid-cols-12 gap-10 items-center">
              ...
              <div className="lg:col-span-5 flex flex-col items-center justify-center space-y-6">
                ...
                {/* Social Connect Links using Inline SVGs */}
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  Enterprise Software Engineer with 4+ years of hands-on technical leadership specializing in high-concurrency Java Spring Boot systems and zero-plugin modern React / Next.js web architecture.
                </p>

                <p className="text-slate-400 text-xs leading-relaxed">
                  At DesignerPal Studio, I personally oversee all structural application architecture, zero-layout-shift frontends, edge deployment protocols, and sub-second performance SLAs for our global partners.
                </p>
        ...
        <section className="space-y-10">
          <div className="text-center space-y-3">
            ...
            <p className="text-slate-400 text-xs max-w-xl mx-auto">
              Built on battle-tested enterprise frameworks and cutting-edge edge infrastructure.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 space-y-3">
              ...
              <h4 className="text-base font-bold text-white">Java & Spring Boot</h4>
              <p className="text-xs text-slate-400">
                4+ years enterprise backend experience building resilient REST APIs and microservice pipelines.
              </p>
            </div>

            <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 space-y-3">
              <Globe className="w-8 h-8 text-indigo-400" />
              <h4 className="text-base font-bold text-white">Next.js & React 19</h4>
              <p className="text-xs text-slate-400">
                Full-stack App Router architecture with Server Components, Tailwind CSS, and zero layout shift.
              </p>
            </div>

            <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 space-y-3">
              <Terminal className="w-8 h-8 text-emerald-400" />
              <h4 className="text-base font-bold text-white">Edge Deployments</h4>
              <p className="text-xs text-slate-400">
                Global Vercel Edge networks with automated SSL provisioning and instant CDN invalidation.
              </p>
            </div>

            <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 space-y-3">
              <Database className="w-8 h-8 text-amber-400" />
              <h4 className="text-base font-bold text-white">Cloud Architecture</h4>
              <p className="text-xs text-slate-400">
                Prisma ORM, PostgreSQL database clustering, and high-concurrency real-time telemetry.
              </p>
            </div>
          </div>
        </section>
