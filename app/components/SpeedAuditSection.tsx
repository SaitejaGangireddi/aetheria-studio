...
export default function SpeedAuditSection() {
  ...
  return (
    <section id="speed-audit" className="py-20 px-6 md:px-12 max-w-6xl mx-auto">
      {/* Header */}
      <div className="text-center max-w-2xl mx-auto mb-10">
        <span className="text-[10px] font-extrabold uppercase tracking-widest text-purple-400 bg-purple-950/80 px-3.5 py-1.5 rounded-full border border-purple-800/80 inline-flex items-center gap-1.5 mb-3">
      ...
      <div className="flex justify-center mb-10">
        <button
          ...
          disabled={isTesting}
          className="px-7 py-3.5 bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-700 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-xs rounded-full shadow-2xl transition-all flex items-center gap-2.5 border border-purple-400/30 hover:scale-105"
        >
          {isTesting ? (
            <>
      ...
      <div className="grid md:grid-cols-2 gap-6" key={testKey}>
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl flex flex-col justify-between backdrop-blur-xl">
          <div>
            ...
            <div className="p-6 min-h-[260px] bg-slate-950/60 relative flex flex-col justify-between">
              <div className="space-y-4">
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="font-mono text-amber-400 font-bold bg-amber-950/60 px-2.5 py-0.5 rounded border border-amber-800/60 text-[11px]">
                    3.82s LCP
                  </span>
                </div>
                  ...
                  <div className="space-y-2.5 pt-1">
                    <div>
                      <div className="flex justify-between text-[10px] text-slate-400 mb-1">
                        ...
                        <span className="text-slate-400 font-mono">850ms</span>
                      </div>
                    ...
                    <div>
                      <div className="flex justify-between text-[10px] text-slate-400 mb-1">
                        ...
                        <span className="text-amber-400 font-mono">1820ms</span>
                      </div>
                      <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
                    ...
                    <div>
                      <div className="flex justify-between text-[10px] text-slate-400 mb-1">
                        ...
                        <span className="text-amber-400 font-mono">1150ms</span>
                      </div>
                      <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
          ...
          <div className="p-4 bg-slate-950 border-t border-slate-800 flex items-center justify-between text-[11px]">
            <span className="flex items-center gap-1.5 text-amber-400 font-semibold">
              <AlertTriangle className="w-3.5 h-3.5" /> High Cumulative Layout Shift
            </span>
            <span className="font-mono font-bold text-slate-400">Score: 38 / 100</span>
          </div>
        </div>

        {/* RIGHT: Next.js Edge Simulation */}
        <div className="bg-slate-900/80 border border-emerald-900/60 rounded-3xl overflow-hidden shadow-2xl flex flex-col justify-between relative backdrop-blur-xl">
            ...
            <div className="p-6 min-h-[260px] bg-slate-950/60 relative flex flex-col justify-between">
              <div className="space-y-4">
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="font-mono text-emerald-400 font-bold bg-emerald-950/80 px-2.5 py-0.5 rounded border border-emerald-800 text-[11px]">
                    0.31s LCP
                  </span>
                </div>

                {/* Simulated Instant Paint Visual */}
                <div className="border border-emerald-900/40 rounded-xl p-4 bg-emerald-950/20 space-y-3 relative">
                  ...
                  <div className="space-y-2.5 pt-1">
                    ...
                    <div>
                      <div className="flex justify-between text-[10px] text-emerald-300 mb-1">
                        ...
                        <span className="text-emerald-400 font-mono">130ms</span>
                      </div>
                      <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
