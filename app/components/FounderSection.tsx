...
export default function FounderSection() {
  const NEW_IMAGE_URL =
    "https://res.cloudinary.com/dmkjnuolr/image/upload/v1785860263/WhatsApp_Image_2026-08-04_at_9.47.20_PM_jxei16.jpg";
    ...
    >
      ...
      <div className="text-center max-w-3xl mx-auto space-y-3">
        ...
        <p className="text-slate-400 text-sm sm:text-base">
          Driving engineering excellence and bespoke digital craftsmanship for
          global enterprises.
        </p>
      </div>
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col items-center justify-center space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <svg
                  className="w-3.5 h-3.5 fill-current text-purple-400"
                  viewBox="0 0 24 24"
                >
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
              DesignerPal Studio was established to bridge the gap between
              high-end digital design and enterprise software reliability. We
              partner with forward-thinking organizations to deliver tailored
              web platforms engineered for speed, conversion, and long-term
              scalability.
            </p>

            <p className="text-slate-400 text-xs leading-relaxed">
              Every engagement is executed under strict quality assurance
              frameworks—combining modern Next.js edge architecture with
              zero-plugin security protocols to guarantee uninterrupted
            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-2 border-t border-slate-800/80">
              <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800/80 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-400">
                    Strict SLAs & zero security debt.
                  </div>
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800/80 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-400">
                    From initial wireframe to live edge deployment.
                  </div>
                </div>
              </div>
            </div>
